...
var protoBuild = angular.module('protoBuild.propertyForm', ['ngRoute','ngMaterial']);
/*
protoBuild.config(['$routeProvider', function($routeProvider) {
  $routeProvider.when('/propertyForm', {
